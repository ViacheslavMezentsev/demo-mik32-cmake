...
/// Возвращает количество микросекунд с момента запуска микроконтроллера.
uint32_t HAL_Micros()
{
 ...
 *
 * Настраивает параметры USART, включая режимы передачи и приема,
 * битовую длину, четность, направление битов и другие настройки.
 */
void USART_Init()
{
 ...
 *
 * Настраивает порты GPIO для работы с устройствами Transmitter и Receiver.
 * В зависимости от выбранной платы, настраиваются различные пины.
 */
void GPIO_Init()
{
