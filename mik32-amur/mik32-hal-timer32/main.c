...
int main()
{
    ...
    // Инициализация периферии GPIO.
    GPIO_Init();

    // Инициализация UART0 для вывода данных.
    ...
    while ( 1 )
    {
        ...
        for ( volatile uint32_t i = 0; i < measure; i++ )
        {
 ...
 *
 * Настраивает таймер 32 для работы в режиме захвата на нулевом канале.
 */
static void Timer32_1_Init( void )
{
