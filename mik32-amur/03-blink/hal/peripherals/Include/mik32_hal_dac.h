...
typedef struct
{
    /*
    * Variable: Instance
    * Базовый адрес регистров ANALOG_REG.
    *
    */
 ...
 * Инициализировать ЦАП в соответствии с настройками в hdac.
 *
 * Parameters:
 * hdac - Указатель на структуру с настройками ЦАП.
 *
