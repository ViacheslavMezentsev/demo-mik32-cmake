...
/* Title: Макросы */
    ...
    */
    ...
    #define HAL_EPIC_TIMER32_0_MASK         (1 << EPIC_LINE_TIMER32_0_S)        
    #define HAL_EPIC_UART_0_MASK            (1 << EPIC_LINE_UART_0_S)           
    #define HAL_EPIC_UART_1_MASK            (1 << EPIC_LINE_UART_1_S)           
    #define HAL_EPIC_SPI_0_MASK             (1 << EPIC_LINE_SPI_0_S)            
    #define HAL_EPIC_SPI_1_MASK             (1 << EPIC_LINE_SPI_1_S)            
    #define HAL_EPIC_GPIO_IRQ_MASK          (1 << EPIC_LINE_GPIO_IRQ_S)         
    #define HAL_EPIC_I2C_0_MASK             (1 << EPIC_LINE_I2C_0_S)            
    #define HAL_EPIC_I2C_1_MASK             (1 << EPIC_LINE_I2C_1_S)            
    #define HAL_EPIC_WDT_MASK               (1 << EPIC_LINE_WDT_S)              
    #define HAL_EPIC_TIMER16_0_MASK         (1 << EPIC_LINE_TIMER16_0_S)        
    #define HAL_EPIC_TIMER16_1_MASK         (1 << EPIC_LINE_TIMER16_1_S)        
    #define HAL_EPIC_TIMER16_2_MASK         (1 << EPIC_LINE_TIMER16_2_S)        
    #define HAL_EPIC_TIMER32_1_MASK         (1 << EPIC_LINE_TIMER32_1_S)        
    #define HAL_EPIC_TIMER32_2_MASK         (1 << EPIC_LINE_TIMER32_2_S)        
    #define HAL_EPIC_SPIFI_MASK             (1 << EPIC_LINE_SPIFI_S)            
    #define HAL_EPIC_RTC_MASK               (1 << EPIC_LINE_RTC_S)              
    #define HAL_EPIC_EEPROM_MASK            (1 << EPIC_LINE_EEPROM_S)           
    #define HAL_EPIC_WDT_DOM3_MASK          (1 << EPIC_LINE_WDT_DOM3_S)         
    #define HAL_EPIC_WDT_SPIFI_MASK         (1 << EPIC_LINE_WDT_SPIFI_S)        
    #define HAL_EPIC_WDT_EEPROM_MASK        (1 << EPIC_LINE_WDT_EEPROM_S)       
    #define HAL_EPIC_DMA_MASK               (1 << EPIC_LINE_DMA_S)              
    #define HAL_EPIC_FREQ_MON_MASK          (1 << EPIC_LINE_FREQ_MON_S)         
    #define HAL_EPIC_PVD_AVCC_MASK          (1 << EPIC_LINE_PVD_AVCC_UNDER_S)         
    #define HAL_EPIC_PVD_AVCCMASK           (1 << EPIC_LINE_PVD_AVCC_OVER_S)          
    #define HAL_EPIC_PVD_VCC_MASK           (1 << EPIC_LINE_PVD_VCC_UNDER_S)          
    #define HAL_EPIC_PVD_VCCMASK            (1 << EPIC_LINE_PVD_VCC_OVER_S)           
    #define HAL_EPIC_BATTERY_NONMASK        (1 << EPIC_LINE_BATTERY_NON_GOOD_S)       
    #define HAL_EPIC_BOR_MASK               (1 << EPIC_LINE_BOR_S)              
    #define HAL_EPIC_TSENS_MASK             (1 << EPIC_LINE_TSENS_S)            
    #define HAL_EPIC_ADC_MASK               (1 << EPIC_LINE_ADC_S)              
    #define HAL_EPIC_DAC0_MASK              (1 << EPIC_LINE_DAC0_S)             
    #define HAL_EPIC_DAC1_MASK              (1 << EPIC_LINE_DAC1_S)  
    ...
    */
    ...
    #define EPIC_CHECK_TIMER32_0()             (EPIC->RAW_STATUS & (1 << EPIC_LINE_TIMER32_0_S))                     
    #define EPIC_CHECK_UART_0()                (EPIC->RAW_STATUS & (1 << EPIC_LINE_UART_0_S))                
    #define EPIC_CHECK_UART_1()                (EPIC->RAW_STATUS & (1 << EPIC_LINE_UART_1_S))                
    #define EPIC_CHECK_SPI_0()                 (EPIC->RAW_STATUS & (1 << EPIC_LINE_SPI_0_S))            
    #define EPIC_CHECK_SPI_1()                 (EPIC->RAW_STATUS & (1 << EPIC_LINE_SPI_1_S))            
    #define EPIC_CHECK_GPIO_IRQ()              (EPIC->RAW_STATUS & (1 << EPIC_LINE_GPIO_IRQ_S))                
    #define EPIC_CHECK_I2C_0()                 (EPIC->RAW_STATUS & (1 << EPIC_LINE_I2C_0_S))            
    #define EPIC_CHECK_I2C_1()                 (EPIC->RAW_STATUS & (1 << EPIC_LINE_I2C_1_S))            
    #define EPIC_CHECK_WDT()                   (EPIC->STATUS     & (1 << EPIC_LINE_WDT_S))            
    #define EPIC_CHECK_TIMER16_0()             (EPIC->RAW_STATUS & (1 << EPIC_LINE_TIMER16_0_S))                
    #define EPIC_CHECK_TIMER16_1()             (EPIC->RAW_STATUS & (1 << EPIC_LINE_TIMER16_1_S))                
    #define EPIC_CHECK_TIMER16_2()             (EPIC->RAW_STATUS & (1 << EPIC_LINE_TIMER16_2_S))                
    #define EPIC_CHECK_TIMER32_1()             (EPIC->RAW_STATUS & (1 << EPIC_LINE_TIMER32_1_S))                
    #define EPIC_CHECK_TIMER32_2()             (EPIC->RAW_STATUS & (1 << EPIC_LINE_TIMER32_2_S))                
    #define EPIC_CHECK_SPIFI()                 (EPIC->RAW_STATUS & (1 << EPIC_LINE_SPIFI_S))            
    #define EPIC_CHECK_RTC()                   (EPIC->RAW_STATUS & (1 << EPIC_LINE_RTC_S))            
    #define EPIC_CHECK_EEPROM()                (EPIC->RAW_STATUS & (1 << EPIC_LINE_EEPROM_S))                
    #define EPIC_CHECK_WDT_DOM3()              (EPIC->RAW_STATUS & (1 << EPIC_LINE_WDT_DOM3_S))                
    #define EPIC_CHECK_WDT_SPIFI()             (EPIC->RAW_STATUS & (1 << EPIC_LINE_WDT_SPIFI_S))                
    #define EPIC_CHECK_WDT_EEPROM()            (EPIC->RAW_STATUS & (1 << EPIC_LINE_WDT_EEPROM_S))                    
    #define EPIC_CHECK_DMA()                   (EPIC->RAW_STATUS & (1 << EPIC_LINE_DMA_S))            
    #define EPIC_CHECK_FREQ_MON()              (EPIC->STATUS     & (1 << EPIC_LINE_FREQ_MON_S))                
    #define EPIC_CHECK_PVD_AVCC_UNDER()        (EPIC->STATUS     & (1 << EPIC_LINE_PVD_AVCC_UNDER_S))                
    #define EPIC_CHECK_PVD_AVCC_OVER()         (EPIC->STATUS     & (1 << EPIC_LINE_PVD_AVCC_OVER_S))                
    #define EPIC_CHECK_PVD_VCC_UNDER()         (EPIC->STATUS     & (1 << EPIC_LINE_PVD_VCC_UNDER_S))                
    #define EPIC_CHECK_PVD_VCC_OVER()          (EPIC->STATUS     & (1 << EPIC_LINE_PVD_VCC_OVER_S))                
    #define EPIC_CHECK_BATTERY_NON_GOOD()      (EPIC->STATUS     & (1 << EPIC_LINE_BATTERY_NON_GOOD_S))                    
    #define EPIC_CHECK_BOR()                   (EPIC->STATUS     & (1 << EPIC_LINE_BOR_S))            
    #define EPIC_CHECK_TSENS()                 (EPIC->RAW_STATUS & (1 << EPIC_LINE_TSENS_S))            
    #define EPIC_CHECK_ADC()                   (EPIC->STATUS     & (1 << EPIC_LINE_ADC_S))            
    #define EPIC_CHECK_DAC0()                  (EPIC->STATUS     & (1 << EPIC_LINE_DAC0_S))            
    #define EPIC_CHECK_DAC1()                  (EPIC->STATUS     & (1 << EPIC_LINE_DAC1_S))                       
