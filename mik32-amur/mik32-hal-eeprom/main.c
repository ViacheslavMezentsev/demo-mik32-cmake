...
int main()
{
    ...
    HAL_EEPROM_Write( &heeprom, EEPROM_PAGE_WORDS * 4, write_data_buf, EEPROM_PAGE_WORDS, HAL_EEPROM_WRITE_EVEN,
        EEPROM_OP_TIMEOUT );
