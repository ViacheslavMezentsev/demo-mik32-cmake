...
int main()
{
    ...
    // Инициализация SPIFI и его сброс.
 ...
 *
 * @param spifi Указатель на структуру SPIFI_HandleTypeDef, представляющую SPIFI.
...
/**
 * @brief Инициализация DMA для работы с SPI
 *
 * Настраивает два канала DMA для передачи данных по SPI.
 * Канал 0 используется для чтения данных из SPI, а канал 1 - для записи данных в SPI.
 */
 ...
 *
 * Настраивает DMA для работы с SPI, включая инициализацию каналов DMA 0 и 1.
 */
static void DMA_Init( void )
{
    /* Настройки DMA */
