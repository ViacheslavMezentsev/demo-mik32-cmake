 ...
 * 
 * Эта функция настраивает системное тактирование микроконтроллера.
 * Она включает осцилляторы, настраивает делители частоты и выбирает источник тактирования для RTC.
 */
void SystemClock_Config( void )
{
 ...
 * 
 * Эта функция настраивает I2C0 для работы в режиме мастера с заданными параметрами.
 */
static void I2C0_Init( void )
{
    /* Общие настройки */
 ...
 * 
 * Эта функция настраивает RTC, устанавливает дату и время, а также включает его.
 * 
 * Дата и время устанавливаются на 22 июня 2023 года, 12:00:00.
 */
static void RTC_Init( void )
{
