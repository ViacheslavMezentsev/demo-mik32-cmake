...
// Значение должно быть не более 255.
 ...
 *
 * Настраивает параметры USART0, включая режим передачи, скорость передачи,
 * количество бит в кадре, биты четности и другие настройки.
 */
void USART_Init()
{
