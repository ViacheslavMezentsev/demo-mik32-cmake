 ...
 * 
 * Обрабатывает прерывания по интерфейсу UART_0.
 */
void trap_handler()
{
 ...
 * 
 * Настраивает USART_0 для работы в асинхронном режиме с 8-битным форматом
 * данных, без четности, с 1 стоп-битом и скоростью 9600 бод.
 */
void USART_Init()
{
