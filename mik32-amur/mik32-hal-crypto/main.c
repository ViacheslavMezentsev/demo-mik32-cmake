...
uint32_t crypto_key[CRYPTO_KEY_KUZNECHIK] =
    { 0x8899aabb, 0xccddeeff, 0x00112233, 0x44556677, 0xfedcba98, 0x76543210, 0x01234567, 0x89abcdef };


void kuznechik_ECB_code()
{
    uint32_t plain_text[] = { 0x11223344,
                              0x55667700,
                              0xffeeddcc,
                              0xbbaa9988,
                              0x00112233,
    ...
    uint32_t cipher_text[] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };

    uint32_t expect_cipher_text[] = { 0x7f679d90,
                                      0xbebc2430,
                                      0x5a468d42,
                                      0xb9d4edcd,
                                      0xb429912c,
...
{
    uint32_t plain_text[] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };

    uint32_t cipher_text[] = { 0x7f679d90,
                               0xbebc2430,
                               0x5a468d42,
                               0xb9d4edcd,
                               0xb429912c,
    ...
    uint32_t expect_plain_text[] = { 0x11223344,
                                     0x55667700,
                                     0xffeeddcc,
                                     0xbbaa9988,
                                     0x00112233,
...
void kuznechik_CBC_code()
{
    ...
    uint32_t expect_cipher_text[] = { 0x50796e7f,
                                      0x4094ce10,
                                      0xbab7374c,
                                      0x981047e3,
                                      0x1ee4f83b,
...
void kuznechik_CBC_decode()
{
    ...
    uint32_t cipher_text[] = { 0x50796e7f,
                               0x4094ce10,
                               0xbab7374c,
                               0x981047e3,
                               0x1ee4f83b,
...
void kuznechik_CTR_code()
{
    ...
    uint32_t expect_cipher_text[] = { 0xf195d8be,
                                      0xc10ed1db,
                                      0xd57b5fa2,
                                      0x40bda1b8,
                                      0x85eee733,
...
void kuznechik_CTR_decode()
{
    ...
    uint32_t cipher_text[] = { 0xf195d8be,
                               0xc10ed1db,
                               0xd57b5fa2,
                               0x40bda1b8,
                               0x85eee733,
