/*
 * Данный пример демонстрирует возможности передачи данных по интерфейсу USART
 ...
 *
 * Настраивает канал DMA 0 для передачи данных из памяти в USART порт.
 *
 ...
 *
 * Настраивает DMA для работы с USART портом.
 */
static void DMA_Init( void )
{
    /* Настройки DMA */
...
/**
 * @brief Инициализация USART порта.
 *
 * Настраивает USART порт 0 для передачи данных.
 */
static void USART_Init()
{
