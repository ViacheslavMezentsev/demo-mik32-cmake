...
/*
 * Задать коэффициент настройки ОИН
 */
void HAL_ADC_VCLBSet(ADC_HandleTypeDef *hadc, uint8_t v_coef);

/*
 * Задать коэффициент настройки опорного источника тока
 */
 ...
 * Задать активный канал АЦП и перевести соответствующий вывод в аналоговую функцию.
 *
 * Parameters:
 * hadc - Указатель на структуру с настройками ADC.
 *
 ...
 * Инициализировать АЦП в соответствии с настройками в hadc.
 *
 * Parameters:
 * hadc - Указатель на структуру с настройками ADC.
 *
 ...
 * Получить результат преобразования АЦП.
 *
 * Parameters:
 * hadc - Указатель на структуру с настройками ADC.
 *
