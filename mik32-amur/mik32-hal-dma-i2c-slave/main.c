...
int main()
{
    ...
    while ( 1 )
    {
        ...
        HAL_StatusTypeDef error_code = HAL_I2C_Slave_Receive_DMA( &hi2c0, data, sizeof( data ), 5 * I2C_TIMEOUT_DEFAULT );
...
static void DMA_CH0_Init( DMA_InitTypeDef* hdma )
{
    ...
    hdma_ch0_tx.ChannelInit.ReadSize = DMA_CHANNEL_SIZE_BYTE;
    hdma_ch0_tx.ChannelInit.ReadBurstSize = 0;
    ...
    hdma_ch0_tx.ChannelInit.WriteSize = DMA_CHANNEL_SIZE_BYTE;
    hdma_ch0_tx.ChannelInit.WriteBurstSize = 0;
